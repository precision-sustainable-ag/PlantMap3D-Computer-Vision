...
with dai.Device(pipeline) as device:
	...
	for photo in photos_in:
		...
		# output_1 = data_o.getAllLayerNames()
		# print(len(output))
		# print(output)
		# print(len(output_1))
		biomass_output, seg_output = data_o.getLayerFp16('1029'), data_o.getLayerFp16('1081')
		print(len(biomass_output))
		print(len(seg_output))
		print(biomass_output[0])
		print(seg_output[0])
		output = seg_output
